...
export default function MiniFormForServices({
  className,
}: {
  className: string;
}) {
  return (
    <form className={className}>
      <figure className="w-full bg-[#148B8A] h-12 p-5 flex justify-start gap-x-5 items-center">
        <svg
          viewBox="0 0 20 19"
          fill="none"
          className="w-5"
      ...
      <div className="">
        <Form
          styleModal={{ form: "p-5 space-y-5", field: "flex flex-col gap-5" }}
        ></Form>
      </div>
    </form>
  );
